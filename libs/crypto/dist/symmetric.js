...
export function encryptSymmetric(plaintext, key, additionalData) {
    try {
...
export function decryptSymmetric(encryptedData, key) {
    try {
...
export function decryptFromStorage(encryptedData, key) {
    const keyUint8 = decodeBase64(key);
    // Extract nonce and encrypted data
